...
## Keep in mind the language is not yet finished so there are many (most) features lacking and it is not going to be coded well because it's written by a 12yo. (me) and I don't know C# well.
